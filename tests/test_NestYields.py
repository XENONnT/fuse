...
class TestNestYields(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.plugin = self.test_context.get_single_plugin("TestRun_00000", "quanta")
    ...
    def test_ChunkInput(self):
        ...
        plugin_input = np.load(os.path.join(os.getcwd(), "data", "interactions_in_roi_and_electric_field_values_for_test.npy"))
