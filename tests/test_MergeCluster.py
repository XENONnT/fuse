...
class TestMergeCluster(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.plugin = self.test_context.get_single_plugin("TestRun_00000", "clustered_interactions")
    ...
    def test_ChunkInput(self):
        ...
        plugin_input = np.load(os.path.join(os.getcwd(), "data", "geant4_interactions_and_cluster_index_for_test.npy"))
